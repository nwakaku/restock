      ...
      const { data, error } = await supabaseUtil.from("orders").insert([
        {
          ...
          subscription_frequency: saveSubscription ? subscriptionFrequency : null,
                ...
                {saveSubscription && (
                  <div className="ml-6 hidden">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Your first delivery will be processed immediately, and subsequent deliveries will be scheduled according to your chosen frequency.
                    </p>
                  </div>
                )}
              </div>
